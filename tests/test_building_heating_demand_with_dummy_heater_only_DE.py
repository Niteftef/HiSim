...
def test_house_with_dummy_heater_for_heating_test(
    ...
    for building_code in d_f["Code_BuildingVariant"]:
        ...
        if country_abbreviation == "DE":
            ...
            #         if country_abbreviation == "DE.N.AB.05.Gen.ReEx.001.002": # or country_abbreviation == "DE.DistrictMZLerch.F.EFH.Ind.SyAv.001.013":
            ...
            #             heating_reference_temperature_in_celsius = -14.0
                ...
                my_occupancy.connect_input(
                    my_occupancy.RealNumberOfApartments,
                    my_building.component_name,
                    my_building.NumberOfApartments
                )
                # =========================================================================================================================================================
