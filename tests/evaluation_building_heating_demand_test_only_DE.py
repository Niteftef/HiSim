...
read_csv_file.to_excel(directory + "\\test_building_heating_demand_dummy_heater_DE_energy_needs1.xlsx", header=True)

xl = pd.read_excel(directory + "\\test_building_heating_demand_dummy_heater_DE_energy_needs1.xlsx")
...
# with open(directory + "\\test.csv", "w") as file:
#     for row in ratios:

#         file.write(str(row) + "\n")
#     file.write(str(min_ratio))
