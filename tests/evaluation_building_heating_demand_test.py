...
with open("C:\\Users\\k.rieck\\Documents\\Software_and_Tools_Documentation\\HiSim\\Tests\\Heating_Test\\Fourth_Try_with_dummy_heater_19.5-20.5_degrees\\test_building_heating_demand_dummy_heater_all_tabula_energy_needs.txt", "r") as myfile:
...
plt.title("Heating Test Fourth Try")
