...
def household_generic_gas_heater(my_sim: Any, my_simulation_parameters: Optional[SimulationParameters] = None) -> None:  # noqa: too-many-statements
    ...
    maximal_mass_flow_in_kilogram_per_second = 12_000 / (4180 * 25),  # kg/s ## -> ~0.07 P_th_max / (4180 * delta_T)
    ...
    # Build Gasheater
    my_gasheater_config = generic_gas_heater.GenericGasHeaterConfig(temperature_delta_in_celsius = temperature_delta_in_celsius, maximal_power_in_watt = maximal_power_in_watt, is_modulating = is_modulating, minimal_thermal_power_in_watt = minimal_thermal_power_in_watt, maximal_thermal_power_in_watt = maximal_thermal_power_in_watt, eff_th_min = eff_th_min, eff_th_max = eff_th_max,
    delta_temperature_in_celsius = delta_temperature_in_celsius, maximal_mass_flow_in_kilogram_per_second = maximal_mass_flow_in_kilogram_per_second, maximal_temperature_in_celsius = maximal_temperature_in_celsius)
    my_gasheater = generic_gas_heater.GasHeater(config=my_gasheater_config, my_simulation_parameters= my_simulation_parameters)
    ...
    my_building.connect_input(my_building.ThermalEnergyDelivered, my_gasheater.component_name, my_gasheater.thermal_output_power_channel)
