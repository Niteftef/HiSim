...
def modular_household_explicit(my_sim: Any, my_simulation_parameters: Optional[SimulationParameters] = None) -> None:  # noqa: MC0001
    ...
    """SURPLUS CONTROLLER"""
    if battery_included or chp_included or smart_devices_included or ev_included or  \
            heating_system_installed in [lt.HeatingSystems.HEAT_PUMP, lt.HeatingSystems.ELECTRIC_HEATING] \
